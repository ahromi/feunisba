...
/** define class
============================================================================ **/
class Model_bjk extends CI_Model
{

	/** function save Bjk
	------------------------------------------------------------------------ **/
	function saveBjk($npm,$permohonan,$dokter,$obat,$lainnya,$status,$tgl_pengajuan) 
	{
		$sql = "INSERT INTO fe_bjk(npm,permohonan,dokter,obat,lainnya,status,tgl_pengajuan) 
...
/* End of file model_bjk.php */
/* Location: ./modules/bjk/models/model_bjk.php */