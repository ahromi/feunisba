<?php
	...
	echo $css_menu;
	/*
		view_bjk.php -> Forms | Bentrok Jadwal Kuliah
	*/
?>
<ul class="breadcrumb">
	<li>Lokasi : </li>
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Bentrok Jadwal Kuliah</li>
</ul>


<h3>Bentrok Jadwal Kuliah</h3>
<div class="innerLR">
			...
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<p><br /></p>
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="fileupload">Unggah Jadwal yang Bentrok</label>
						...
						</div><i>Susun dalam Tabel dengan urutan : Mata Kuliah/Dosen/Hari/Tempat/Jam</i>
						<!-- // Group END -->
					</div>
					<!-- // Column END -->
				</div>
