<?php
	...
	echo $css_menu;
	/*
		view_skpdpl.php -> Forms | Surat Keterangan Pindah Dari PT Luar
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Keterangan Pindah Dari PT Luar</li>
</ul>

<h3>Surat Keterangan Pindah Dari PT Luar</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/skpdpl/inputSkpdpl',$attrib);
		?>
<!--	<form class="form-horizontal margin-none" id="validateSubmitForm" action="<?php echo base_url()?>index.php/skpdpl/inputSkpdpl" method="post" enctype="multipart/form-data" autocomplete="off"> -->
