<?php
	...
	echo $css_menu;
	/*
		view_skpapu.php -> Forms | Surat Keterangan Pindah Antar PS Unisba
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Keterangan Pindah Antar PS Unisba</li>
</ul>

<h3>Surat Keterangan Pindah Antar PS Unisba</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/skpapu/inputSkpapu',$attrib);
		?>
<!--	<form class="form-horizontal margin-none" id="validateSubmitForm" action="<?php echo base_url()?>index.php/skpapu/inputSkpapu" method="post" enctype="multipart/form-data" autocomplete="off"> -->
		...
		<div class="widget widget-heading-simple widget-body-gray" data-toggle="collapse-widget">		
			<!-- Widget heading -->
			<div class="widget-head">
				<h4 class="heading">Data Fakultas dan Program Studi Asal</h4>
			</div>
			<!-- // Widget heading END -->
			<!-- // Widget body -->
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="fakultas_asal">Fakultas Asal</label>
							<div class="controls"><input class="span12" id="fakultas_asal" name="fakultas_asal" type="text" /></div>
						</div>
						<!-- // Group END -->
					</div>
					<!-- // Column END -->
					...
					<div class="span6">
						...
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="prodi_asal">Program Studi Asal</label>
							<div class="controls"><input class="span12" id="prodi_asal" name="prodi_asal" type="text" /></div>
						</div>
						<!-- // Group END -->
					</div>
					<!-- // Column END -->
			...
			<div class="widget-body">
				...
				<div class="row-fluid">
					...
					<p><br /></p>
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="fileupload1">DPP Terakhir</label>
						...
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="fileupload2">Surat Rekomendasi Dekan/Kaprodi asal</label>
							<div class="fileupload fileupload-new controls" data-provides="fileupload">
								<div class="input-append">
									<div class="uneditable-input"><i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span></div>
									<span class="btn btn-default btn-file">
					...
					<div class="span6">
						...
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="fileupload3">Transkrip nilai yang telah disahkan oleh Dekan Fakultas asal</label>
							<div class="fileupload fileupload-new controls" data-provides="fileupload">
								<div class="input-append">
									<div class="uneditable-input"><i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span></div>
									<span class="btn btn-default btn-file">
