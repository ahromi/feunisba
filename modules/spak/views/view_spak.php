<?php
	...
	echo $css_menu;
	/*
		view_spak.php -> Forms | Surat Permohonan Aktif Kuliah
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Permohonan Aktif Kuliah</li>
</ul>

<h3>Surat Permohonan Aktif Kuliah</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/spak/inputSpak',$attrib);
		?>	
		<!-- Widget -->
