<?php
	...
	echo $css_menu;
	/*
		view_detail_spak.php -> Forms | View Detail Admin SPAK
	*/
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>View Detail Admin SPAK</li>
</ul>

<h3>View Detail Admin SPAK</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/spak/prosesSpak?zXdu88='.$cetak->idfe_spak,$attrib);
		?>	
		<!-- Widget -->
				...
				<div class="row-fluid">
					...
					<p><br /></p>
						...
						<div class="control-group">
							...
							<div class="controls"><a href="#lihat-dpp" data-toggle="modal"><?php echo '<img src="'.base_url().'uploads/'.$cetak->npm.'/spak/'.$cetak->dpp.'" alt="DPP Terakhir" class="img thumb" />'; ?></a></div>
						</div>
						<!-- // Group END -->
					</div>
					<!-- // Column END -->
...
<div class="modal hide fade" id="lihat-dpp">
	...
	<div class="modal-body">
		<?php echo '<img src="'.base_url().'uploads/'.$cetak->npm.'/spak/'.$cetak->dpp.'" />';?>
		<br />
		<br />
		<!-- Row -->
		<div class="row-fluid">
