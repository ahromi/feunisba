<?php
	...
	echo $css_menu;
	/*
		view_skk.php -> Forms | Surat Keterangan Kuliah
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Keterangan Kuliah</li>
</ul>

<h3>Surat Keterangan Kuliah</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/skk/inputSkk',$attrib);
		?>
<!--	<form class="form-horizontal margin-none" id="validateSubmitForm" action="<?php echo base_url()?>index.php/skk/inputSkk" method="post" enctype="multipart/form-data" autocomplete="off"> -->
