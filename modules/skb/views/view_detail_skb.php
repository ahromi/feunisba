<?php
	...
	echo $css_menu;
	/*
		view_detail_skb.php -> Forms | View Detail Admin SKB
	*/
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>View Detail Admin SKB</li>
</ul>

<h3>View Detail Admin SKB</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/skb/prosesSkb?zXdu88='.$cetak->idfe_skb,$attrib);
		?>	
		<!-- Widget -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php
									...
									$js = 'id="tingkat" class="span12" disabled="disabled"';
									
									echo form_dropdown('tingkat', $options, $cetak->tingkat, $js);
								?>
							</div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php
									...
									$js = 'id="semester" class="span12" disabled="disabled"';
									
									echo form_dropdown('semester', $options, $cetak->semester, $js);
								?>
							</div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php
									...
									$js = 'id="tahun_akademik" class="span12" disabled="disabled"';
									
									echo form_dropdown('tahun_akademik', $options, $cetak->tahun_akademik, $js);
								?>
							</div>
						</div>
						<!-- // Group END -->
				...
				<div class="row-fluid">
					...
					<p><br /></p>
						...
						<div class="control-group">
							...
							<div class="controls"><a href="#lihat-dpp" data-toggle="modal"><?php echo '<img src="'.base_url().'uploads/'.$cetak->npm.'/skb/'.$cetak->dpp.'" alt="DPP Terakhir" class="img thumb" />'; ?></a></div>
						</div>
						<!-- // Group END -->
					</div>
					<!-- // Column END -->
...
<div class="modal hide fade" id="lihat-dpp">
	...
	<div class="modal-body">
		<?php echo '<img src="'.base_url().'uploads/'.$cetak->npm.'/skb/'.$cetak->dpp.'" />';?>
		<br />
		<br />
		<!-- Row -->
		<div class="row-fluid">
