...
/*Untuk Mengaktifkan icon link Form pada top menu*/
	echo $css_menu;
	/*
		view_sktmb.php -> Forms | Surat Keterangan Tidak Menerima Beasiswa
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Keterangan Tidak Menerima Beasiswa</li>
</ul>

<h3>Surat Keterangan Tidak Menerima Beasiswa</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/sktmb/inputSktmb',$attrib);
		?>
