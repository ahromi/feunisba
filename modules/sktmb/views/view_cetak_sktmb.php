...
<p align="center">
<font face="Tahoma, sans-serif"><u><b>SURAT PERNYATAAN</b></u></font>
</p>
...
<div class="paragrap">
	...
	<tr>
		<td class="limapuluh">Tempat Tanggal Lahir</td>
		<td class="sepuluh"> : </td>
		<td><?php $tgl_lahir = new Datetime($cetak->tgl_lahir); echo $cetak->tempat_lahir.', '.tgl_indo($tgl_lahir->format('Y-m-d')); ?></td>
	</tr>
	<tr>
		<td class="limapuluh">Agama</td>
		<td class="sepuluh"> : </td>
		<td><?php echo $cetak->agama; ?></td>
	</tr>
	</table>
	<br>
	<br>
...
<div class="paragrap">
Belum pernah menerima dan Tidak Sedang mengajukan beasiswa dari sumber manapun.
	<br>
	<br>
</div>
<div class="paragrap">
