<?php
	...
	echo $css_menu;
	/*
		view_ssp.php -> Forms | Surat Keterangan Kuliah
	*/
?>
...
<ul class="breadcrumb">
	...
	<li>Forms</li>
	<li class="divider"> | </li>
	<li>Surat Survai Penelitian</li>
</ul>

<h3>Surat Survai Penelitian</h3>
<div class="innerLR">
...
<!-- Form -->
		<?php 
			$attrib	= array('class'	=> 'form-horizontal margin-none',
									'name'	=> 'form_input',
									'method'	=> 'post');
			echo form_open_multipart('index.php/ssp/inputSsp',$attrib);
		?>
